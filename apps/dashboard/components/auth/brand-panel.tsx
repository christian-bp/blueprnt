...
// centered, animated value line (the midday composition, in light mode); the
// wordmark sits in the top-left corner. Content sits above the aurora via z-10;
// overflow-hidden clips the blobs to the panel.
