...
describe("RatingResult", () => {
  ...
  it("shows the not-ready state, never a stale score, when a later criterion made a completed role incomplete", () => {
    // completed stays true once set (completion.ts), but a criterion added after
