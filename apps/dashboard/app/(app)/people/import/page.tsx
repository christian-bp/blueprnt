...
// Full-screen takeover, like the onboarding wizard. The wizard's WizardShell is
// a h-svh frame, so inside the app shell's padded content column it gets
...
// <main> handles internal scrolling via WizardShell.
