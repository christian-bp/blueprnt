...
6. Chattinnehåll är raderbart användardata från dag ett: radering av en användare hard-raderar alla trådar och meddelanden (schemalagd, chunkad). Användaren instrueras i UI och systemprompt att inte dela persondata; retentionspolicy för arkiverade trådar avgörs före lansering (go-live-checklistan).
