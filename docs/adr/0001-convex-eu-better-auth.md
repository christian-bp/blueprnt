...
- **E-postleverantör (subprocessor).** Transaktionsmejl skickas via Sweego (`@christian-ek/sweego`-komponenten); mottagarens e-postadress och meddelandekropp behandlas hos Sweego. Sweego ska uppfylla samma EU-residenskrav som Convex (EU-hosting + DPA) och förs upp på subprocessor-/DPA-listan, samma krav som tidigare ställdes på Scaleway TEM och som diskvalificerade Resend (US-lagring). **Att göra före go-live:** bekräfta Sweegos hosting-region och teckna DPA.
