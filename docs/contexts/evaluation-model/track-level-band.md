...
> 4. **OMDÖPT 2026-08-05 (ADR-0014): begreppen heter i dag Nivå, Senioritet och Steg.** Dokumentets Band heter nu **Nivå** (kod `level`, Nivå 1 är högst), dokumentets Level/Nivå (individens senioritet inom rollens track) heter **Senioritet** (kod `seniority`), och kriteriets 0 till 5-lägen heter **Steg** (kod `step`). Begreppen är oförändrade, bara orden är nya. Texten nedan står kvar med sina ursprungliga ord som källdokument; läs den med den här nyckeln.
>
