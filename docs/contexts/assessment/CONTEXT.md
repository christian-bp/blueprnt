...
- **Ingen nivåöverride (avviker från briefen)**: briefen nämnde manuell nivåjustering med dokumenterad anledning; vi tar bort det. Nivån är alltid det deterministiska utfallet — vill man ändra justerar man betyg eller modell (stöds av live-omräkning + händelselogg). Stärker objektiviteten; lätt att återinföra senare.
