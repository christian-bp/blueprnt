...
export function assistantSystemPrompt(args: AssistantPromptContext): string {
  ...
  return [
    ...
    "- Criterion: one requirement every role is evaluated against, chosen from a library of 22 and belonging to exactly one dimension. A model holds 6 to 8, capped per dimension at 2/2/3/1. Each criterion has full anchor texts at steps 1, 3, and 5, with considered midpoint anchors at 2 and 4.",
