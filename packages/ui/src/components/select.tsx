    ...
    <SelectPrimitive.Portal>
      ...
      >
        <SelectPrimitive.Popup
          ...
          // Local fix vs upstream: `w-(--anchor-width)` pinned the popup to the
          // trigger width and clipped items whose labels are longer than the
          // trigger (overflow-x-hidden). Let the popup grow to its content,
          // never narrower than the trigger, capped to the viewport.
