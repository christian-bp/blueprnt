...
const frameVariants = cva(
  [
    ...
    // Local deviation from the ReUI registry: upstream's published frame.json
    // (and Verve's own production DOM, verified) ships truncated variant
    // tokens here, orphans like "(--radius-xl)]" left over from per-variant
    // radius conditions. They are inert junk classes in every Frame's DOM,
    // so they are stripped; only the surviving default assignment is kept.
